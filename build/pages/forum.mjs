...
const T = {
  en: {
    ...
    privacyP:
      'Your email address, a display name you choose, and what you post. The password is hashed by Firebase and never reaches this site. All of it lives in Firebase, in the EU. Every other page on this site still stores nothing at all.',
  },
  ...
  de: {
    ...
    privacyP:
      'Deine E-Mail-Adresse, einen selbst gewählten Anzeigenamen und das, was du schreibst. Das Passwort hasht Firebase, es erreicht diese Seite nie. Alles davon liegt bei Firebase, in der EU. Jede andere Seite hier speichert weiterhin gar nichts.',
  },
};
...
export function script(lang) {
  ...
  '      fb.sendPasswordResetEmail(auth, mail).catch(function () {}).then(function () { alert(L.resetSent); });',
  '    });',
  '',
