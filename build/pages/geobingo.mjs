...
export const meta = {
  ...
  es: {
    title: 'GeoBingo',
    description: 'Una ronda privada de Street View. Acceso con código.',
  },
};
...
export const TEXTE = {
  ...
  es: {
    ...
    anmeldenH: 'Iniciar sesión',
    anmeldenP: 'Skillry decide por cuenta quién puede abrir una ronda. Sin contraseña que inventar — tu cuenta de Google basta.',
    mitGoogle: 'Continuar con Google',
    anmeldenHinweis: 'Iniciar sesión carga Firebase desde Google. Hasta que pulses el botón, esta página no ha hablado con nadie.',
    abmelden: 'Cerrar sesión',
    erstAnmelden: 'Inicia sesión primero.',
    gesperrtH: 'Aún sin desbloquear',
    gesperrtP: 'Tu cuenta tiene sesión iniciada pero no está en la lista de acceso. Abrir tu propia ronda necesita un desbloqueo, una sola vez.',
    gesperrtHinweis: 'Un enlace de invitación sigue funcionando: a la ronda de otra persona puedes unirte ya — solo no puedes abrir una tú.',
    zugangAnfragen: 'Solicitar acceso',
    verwaltung: 'Administración',
    anfragen: 'Solicitudes',
    keineAnfragen: 'Sin solicitudes.',
    freischalten: 'Desbloquear',
    ablehnen: 'Descartar',
    freigeschaltete: 'Desbloqueados',
    niemandFrei: 'Nadie desbloqueado todavía.',
    entziehen: 'Revocar',
    freigeschaltetOk: 'Desbloqueado.',
    rauswerfen: 'Sacar de la sala',
    adminHinweis: 'Eres admin por tu dirección de correo — eso está fijado en firestore.rules y no se puede conceder desde aquí. Todos los demás necesitan una entrada en esta lista.',
    anfrageLaeuft: 'Solicitud enviada. Te desbloquearán a mano.',
    anfrageRaus: 'Solicitud enviada.',

    nameH: '¿Cómo te llaman los demás?',
    nameP: 'Sin cuenta, sin correo, sin contraseña. El nombre vive en la sala y en ningún otro sitio.',
    namePlatz: 'Tu nombre',
    weiter: 'Continuar',
    nameZuKurz: 'Al menos dos caracteres.',

    heimZeile: 'Street View, una lista de palabras y un reloj. Descubre la cosa, haz clic en la palabra.',
    jetztSpielen: 'Jugar ahora',
    lobbysDurchsuchen: 'Ver salas',
    mitCodeBeitreten: 'Unirse con código',
    discord: 'Únete a nuestro Discord',
    keineLobbys: 'Ahora mismo no hay salas públicas. Abre una — puedes hacerla pública en los ajustes.',
    oeffentlich: 'Sala pública',
    oeffentlichHinweis: 'Aparece en «Ver salas» para todos los que tengan sesión iniciada. Apagado significa que el enlace de invitación es la única entrada.',
    nurFrei: 'Solo cuentas desbloqueadas',
    nurFreiHinweis: 'Entonces el enlace de invitación por sí solo no basta — un enlace filtrado no vale nada. Para un torneo: encendido.',
    code: 'Código de sala',
    beitreten: 'Unirse',
    codeFalsch: 'Un código de sala tiene cinco caracteres.',
    lobbyWeg: 'No hay sala con ese código.',
    lobbyLaeuft: 'Esa ronda ya está en marcha.',

    verlassen: 'Salir',
    einladelink: 'Enlace de invitación',
    linkKopieren: 'Copiar',
    kopiert: 'Enlace de invitación copiado.',
    kopierenGeht: 'El portapapeles no está disponible aquí. El enlace queda ahora a la vista — cuidado si estás en stream.',
    aufdecken: 'Destapar',
    aufdeckenHinweis: 'Tapado para que no acabe en el stream. Un clic lo destapa; se vuelve a tapar solo a los 15 segundos. Copiar funciona sin destapar.',

    lobbyH: 'Sala',
    rundeBeenden: 'Terminar la ronda',
    wirklichBeenden: '¿Terminarla de verdad?',
    woerterH: 'Palabras',
    woerterP: 'Tus propias palabras son el sentido de esto. Los paquetes de abajo solo llenan la lista rápido.',
    einstellungenP: 'Todo lo de aquí lo decide el anfitrión, y todos ven el cambio al instante.',
    spielerP: 'Cualquiera con el enlace de invitación aterriza aquí.',
    wortPlatz: 'Un perro, un autobús rojo, alguien en una escalera…',
    punkte: 'Puntos',
    hinzu: 'Añadir',
    paketeH: 'Paquetes',
    alleWeg: 'Quitar todas',
    entfernen: 'Quitar',
    keineWoerter: 'Aún no hay palabras.',
    zuVieleWoerter: 'Cuarenta palabras es el techo.',

    einstellungenH: 'Ajustes',
    spielwahl: 'Juego',
    spielBingo: 'GeoBingo',
    spielRadar: 'GeoRadar',
    spielHinweis: 'Una sala, dos juegos. GeoBingo: cada uno aterriza en un sitio distinto y caza las palabras. GeoRadar: todos aterrizan en el MISMO sitio y compiten por adivinar dónde es — el más cercano gana, y el reloj deshace empates.',
    radarKeineWoerter: 'GeoRadar no necesita palabras — el propio lugar es el acertijo. La lista se queda aquí para cuando vuelvas a cambiar.',
    springenWahl: 'Saltos de mapa',
    sprAus: 'Apagado',
    sprGast: 'Anfitrión',
    sprAlle: 'Todos',
    springenHinweis: 'Quién puede saltar el panorama a otro sitio por el minimapa. Cada salto confirmado carga un panorama facturado; buscar en el mapa es gratis.',
    dauer: 'Duración de la ronda',
    min: 'min',
    bewegung: 'Movimiento',
    bewFrei: 'Libre',
    bewPfeile: 'Flechas',
    bewAus: 'Congelado',
    bewegungHinweis: 'Congelado es lo más difícil — y lo más barato. Google factura el Street View dinámico por panorama, andar incluido.',
    panoramen: 'panoramas para esta ronda',
    vonTageskontingent: 'de %n al día',
    ueberKontingent: 'Por encima del tope diario — la ronda se parará a medias.',
    modus: 'Modo',
    modEinzeln: 'Cada uno a lo suyo',
    modTeams: 'Equipos',
    nurStaedte: 'Solo centros urbanos',
    nurStaedteHinweis: 'Más que encontrar. Apágalo para tener de todo, de una autopista a un camino rural.',
    punkteZeigen: 'Mostrar puntos en vivo',
    punkteZeigenHinweis: 'Apagado significa que nadie ve cómo van los demás hasta el final.',
    regionenH: 'Regiones',
    alleAn: 'Todas',
    alleAus: 'Ninguna',

    spielerH: 'Jugadores',
    niemandDa: 'Aún no hay nadie.',
    gastgeber: 'anfitrión',
    teamWechseln: 'Cambiar',
    team: 'Equipo',
    losGehts: 'Empezar la ronda',
    brauchtWort: 'Al menos una palabra.',
    brauchtRegion: 'Al menos una región.',
    wartetAufGastgeber: 'Esperando al anfitrión.',

    deineKarte: 'Tu cartón',
    einklappen: 'Plegar',
    hudAus: 'Ocultar la superposición (H)',
    karteAuf: 'Abrir el mapa',
    karteZu: 'Cerrar el mapa',
    weltkarte: 'Mapa del mundo',
    sprungFrage: '¿Saltar aquí?',
    sprungKosten: 'Carga un panorama facturado.',
    sprungJa: 'Saltar',
    sprungNein: 'Cancelar',
    suchtPano: 'Buscando un panorama cerca de ese punto…',
    keinPanoDort: 'No hay Street View cerca de ese punto. Prueba más cerca de una carretera.',
    tippHinweis: 'Haz clic en el mapa donde creas que estás, y luego fíjalo.',
    tippAbgeben: 'Fijar mi marca',
    tippSteht: 'Tu marca está fijada.',
    tippErst: 'Pon primero un pin en el mapa.',
    alleGetippt: 'Todos han marcado — puedes terminar la ronda.',
    zielOrt: 'Lugar real',
    radarErgebnisP: 'La marca más cercana gana; en caso de empate, la más rápida. El mapa enseña cada pin junto al lugar real.',
    keinTipp: 'sin marca',
    suchtOrt: 'Buscando un lugar con panoramas…',
    zeitUm: 'Se acabó el tiempo.',
    punkteVersteckt: 'Los puntos están ocultos hasta el final.',
    kartenFehlerH: 'Street View no cargó',
    kartenFehlerP: 'Falta la clave, está restringida a otra dirección, o una de las dos APIs está apagada: Maps JavaScript API y Street View Static API.',
    keinOrt: 'Cuarenta intentos en esas regiones y ningún panorama. Elige otra región, o apaga «solo centros urbanos».',
    keineRegion: 'Ninguna región seleccionada.',

    pruefungH: 'Los hallazgos de todos',
    pruefungP: 'Haz clic en una imagen para plantarte dentro en 3D. Un hallazgo solo cae si todos los demás jugadores le bajan el pulgar — no hacer nada lo deja contar.',
    auswerten: 'Mostrar el resultado',
    nichtsGefunden: 'Nadie encontró nada. Pasa.',
    daumenHoch: 'Cuenta',
    daumenRunter: 'No cuenta',
    in3d: 'Abrir en Street View 3D',
    in3dKurz: '3D',
    schliessen: 'Cerrar',
    ...
    funde: 'hallazgos',
    nochmal: 'Otra ronda',
    bilderAnsehen: 'Volver a las imágenes',

    errAnonymAus: 'El inicio de sesión con Google está apagado en la consola de Firebase (Authentication → Sign-in method → Google).',
    errRegeln: 'La base de datos lo rechazó. Probablemente las reglas de GeoBingo aún no están desplegadas — mira docs/SETUP-MAPS.md, paso 2.',
    errNetz: 'Sin conexión con la base de datos.',
    errAllgemein: 'Eso no ha funcionado.',

    setupH: 'Aún no está encendido',
    setupKarte: 'En content/geobingo.json no hay clave de Google Maps, así que no hay Street View que enseñar.',
    setupDb: 'Firebase no está configurado, así que no hay sala a la que unirse.',
    setupCta: 'La puesta en marcha, escrita entera',
    ohneJs: 'Este juego necesita JavaScript. No existe una versión sin él.',
  },
};
...
const benannt = (o, lang) => ({ name: o[lang], beschreibung: o[lang + 'D'] || '' });
